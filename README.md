...
7. **India Regional Context Agent** — interprets monsoon cycles, climate zones, and state-level child vulnerability across **12 Indian regions**
...
| `/api/analyze` | GET | Service metadata |
